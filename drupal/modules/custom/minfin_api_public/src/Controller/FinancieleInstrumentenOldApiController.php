...
use Drupal\minfin_api\Controller\FinancieleInstrumentenOldApiController as FinancieleInstrumentenOldPrivateApiController;
use Symfony\Component\HttpFoundation\JsonResponse;

/**
 * The swagger API for the Financiele instrumenten.
 */
class FinancieleInstrumentenOldApiController extends FinancieleInstrumentenOldPrivateApiController {
   ...
   *   tags = { "Financiele instrumenten (v1)" },
   *   @SWG\Parameter(
   *     name = "year[]",
