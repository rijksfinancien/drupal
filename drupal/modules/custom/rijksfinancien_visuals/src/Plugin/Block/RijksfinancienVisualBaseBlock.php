...
/**
 * Provides a 'RijksfinancienVisualBaseBlock' Block.
 */
abstract class RijksfinancienVisualBaseBlock extends BlockBase implements ContainerFactoryPluginInterface {
